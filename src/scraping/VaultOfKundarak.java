...
public class VaultOfKundarak {
    ...
    private static final String XPATH_ITEM_BONUSES = "//*[@id=\"gold\"]/div/div[2]/div[2]/div/div/div[2]/div[4]";


    public static Item generateItem(String name) {
        Item item = new Item();

        System.out.println(Internet.getContents("https://vaultofkundarak.com/item/Legendary_Bracers_of_the_Fallen_Hero"));
